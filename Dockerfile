...
<<<<<<< HEAD
COPY --from=builder /usr/src/raven_import_and_submit_api/target/raven-import-and-submit-api-1.3.3.war /usr/local/tomcat/webapps/raven-import-and-submit-api.war
=======
COPY --from=builder /usr/src/raven_import_and_submit_api/target/raven-import-and-submit-api-1.3.2.war /usr/local/tomcat/webapps/raven-import-and-submit-api.war
>>>>>>> MRP-original/main
