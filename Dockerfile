...
COPY --from=builder /usr/src/raven_import_and_submit_api/target/raven-import-and-submit-api-1.1.1.war /usr/local/tomcat/webapps/raven-import-and-submit-api.war
