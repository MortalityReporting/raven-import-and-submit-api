...
public class MDIAndEDRSModelFields extends BaseModelFields{
	...
	@CsvBindByName
	public String INJURYLOCATION_STREET = "";
	@CsvBindByName
	public String INJURYLOCATION_CITY = "";
	@CsvBindByName
	public String INJURYLOCATION_COUNTY = "";
	@CsvBindByName
	public String INJURYLOCATION_STATE = "";
	@CsvBindByName
	public String INJURYLOCATION_ZIP = "";
	@CsvBindByName
	public String INJURYLOCATION_COUNTRY = "";
	@CsvBindByName
	...
	public MDIAndEDRSModelFields(String BASEFHIRID, String SYSTEMID, String MDICASEID, String EDRSCASEID, String FIRSTNAME, String MIDNAME, String LASTNAME, String SUFFIXNAME, String AGE, String AGEUNIT, String RACE, String GENDER, String ETHNICITY, String BIRTHDATE, String MRNNUMBER, String JOBTITLE, String INDUSTRY, String LANGUAGE, String MARITAL, String POSSIBLEID, String CAUSEA, String CAUSEB, String CAUSEC, String CAUSED, String OSCOND, String MANNER, String DISPMETHOD, String CHOWNINJURY, String DURATIONA, String DURATIONB, String DURATIONC, String DURATIOND, String CASENOTES, String ATWORK, String JOBRELATED, String REPORTDATE, String REPORTTIME, String FOUNDDATE, String FOUNDTIME, String CDEATHDATE, String CDEATHTIME, String EVENTDATE, String EVENTTIME, String PRNDATE, String PRNTIME, String EXAMDATE, String CINJDATE, String CINJTIME, String CINJDATEEARLY, String CINJDATELATE, String CIDATEFLAG, String CDEATHESTABLISHEMENTMETHOD, String LKADATE, String LKATIME, String CASEYEAR, String ATHOSPDATE, String ATHOSPTIME, String RESSTREET, String RESCITY, String RESCOUNTY, String RESSTATE, String RESZIP, String RESCOUNTRY, String DEATHLOCATION_STREET, String DEATHLOCATION_CITY, String DEATHLOCATION_COUNTY, String DEATHLOCATION_STATE, String DEATHLOCATION_ZIP, String DEATHLOCATION_COUNTRY, String DEATHLOCATIONTYPE, String INJURYLOCATION_STREET, String INJURYLOCATION_CITY, String INJURYLOCATION_COUNTY, String INJURYLOCATION_STATE, String INJURYLOCATION_ZIP, String INJURYLOCATION_COUNTRY, String FOUNDADDR_STREET, String FOUNDADDR_CITY, String FOUNDADDR_COUNTY, String FOUNDADDR_STATE, String FOUNDADDR_ZIP, String EVENTPLACE, String EVENTADDR_STREET, String EVENTADDR_CITY, String EVENTADDR_COUNTY, String EVENTADDR_STATE, String EVENTADDR_ZIP, String PRNPLACE, String PRNSTREET, String PRNCITY, String PRNCOUNTY, String PRNSTATE, String PRNZIP, String DISP_PLACE, String DISP_STREET, String DISP_CITY, String DISP_COUNTY, String DISP_STATE, String DISP_ZIP, String RESNAME, String LKAWHERE, String HOSPNAME, String SCENEADDR_STREET, String SCENEADDR_CITY, String SCENEADDR_COUNTY, String SCENEADDR_STATE, String SCENEADDR_ZIP, String CERTIFIER_NAME, String CERTIFIER_TYPE, String SURGERY, String SURGDATE, String SURGREASON, String HCPROVIDER, String AUTOPSYPERFORMED, String AUTOPSYRESULTSAVAILABLE, String AUTOPSY_OFFICENAME, String AUTOPSY_STREET, String AUTOPSY_CITY, String AUTOPSY_COUNTY, String AUTOPSY_STATE, String AUTOPSY_ZIP, String CUSTODY, String PREGNANT, String TOBACCO, String TRANSPORTATION, String MENAME, String MEPHONE, String MELICENSE, String ME_STREET, String ME_CITY, String ME_COUNTY, String ME_STATE, String ME_ZIP, String PRONOUNCERNAME, String CERTIFIER_IDENTIFIER, String CERTIFIER_IDENTIFIER_SYSTEM) {
		...
		this.INJURYLOCATION_STREET = INJURYLOCATION_STREET;
		this.INJURYLOCATION_CITY = INJURYLOCATION_CITY;
		this.INJURYLOCATION_COUNTY = INJURYLOCATION_COUNTY;
		this.INJURYLOCATION_STATE = INJURYLOCATION_STATE;
		this.INJURYLOCATION_ZIP = INJURYLOCATION_ZIP;
		this.INJURYLOCATION_COUNTRY = INJURYLOCATION_COUNTRY;
	...
	public String getINJURYLOCATION_STREET() {
		return this.INJURYLOCATION_STREET;
	}

	public void setINJURYLOCATION_STREET(String INJURYLOCATION_STREET) {
		this.INJURYLOCATION_STREET = INJURYLOCATION_STREET;
	}

	public String getINJURYLOCATION_CITY() {
		return this.INJURYLOCATION_CITY;
	}

	public void setINJURYLOCATION_CITY(String INJURYLOCATION_CITY) {
		this.INJURYLOCATION_CITY = INJURYLOCATION_CITY;
	}

	public String getINJURYLOCATION_COUNTY() {
		return this.INJURYLOCATION_COUNTY;
	}

	public void setINJURYLOCATION_COUNTY(String INJURYLOCATION_COUNTY) {
		this.INJURYLOCATION_COUNTY = INJURYLOCATION_COUNTY;
	}

	public String getINJURYLOCATION_STATE() {
		return this.INJURYLOCATION_STATE;
	}

	public void setINJURYLOCATION_STATE(String INJURYLOCATION_STATE) {
		this.INJURYLOCATION_STATE = INJURYLOCATION_STATE;
	}

	public String getINJURYLOCATION_ZIP() {
		return this.INJURYLOCATION_ZIP;
	}

	public void setINJURYLOCATION_ZIP(String INJURYLOCATION_ZIP) {
		this.INJURYLOCATION_ZIP = INJURYLOCATION_ZIP;
	}

	public String getINJURYLOCATION_COUNTRY() {
		return this.INJURYLOCATION_COUNTRY;
	}

	public void setINJURYLOCATION_COUNTRY(String INJURYLOCATION_COUNTRY) {
		this.INJURYLOCATION_COUNTRY = INJURYLOCATION_COUNTRY;
	}
	...
	public MDIAndEDRSModelFields INJURYLOCATION_STREET(String INJURYLOCATION_STREET) {
		setINJURYLOCATION_STREET(INJURYLOCATION_STREET);
		return this;
	}

	public MDIAndEDRSModelFields INJURYLOCATION_CITY(String INJURYLOCATION_CITY) {
		setINJURYLOCATION_CITY(INJURYLOCATION_CITY);
		return this;
	}

	public MDIAndEDRSModelFields INJURYLOCATION_COUNTY(String INJURYLOCATION_COUNTY) {
		setINJURYLOCATION_COUNTY(INJURYLOCATION_COUNTY);
		return this;
	}

	public MDIAndEDRSModelFields INJURYLOCATION_STATE(String INJURYLOCATION_STATE) {
		setINJURYLOCATION_STATE(INJURYLOCATION_STATE);
		return this;
	}

	public MDIAndEDRSModelFields INJURYLOCATION_ZIP(String INJURYLOCATION_ZIP) {
		setINJURYLOCATION_ZIP(INJURYLOCATION_ZIP);
		return this;
	}

	public MDIAndEDRSModelFields INJURYLOCATION_COUNTRY(String INJURYLOCATION_COUNTRY) {
		setINJURYLOCATION_COUNTRY(INJURYLOCATION_COUNTRY);
		return this;
	}
	...
	public String toString() {
		return "{" +
			...
			", INJURYLOCATION_STREET='" + getINJURYLOCATION_STREET() + "'" +
			", INJURYLOCATION_CITY='" + getINJURYLOCATION_CITY() + "'" +
			", INJURYLOCATION_COUNTY='" + getINJURYLOCATION_COUNTY() + "'" +
			", INJURYLOCATION_STATE='" + getINJURYLOCATION_STATE() + "'" +
			", INJURYLOCATION_ZIP='" + getINJURYLOCATION_ZIP() + "'" +
			", INJURYLOCATION_COUNTRY='" + getINJURYLOCATION_COUNTRY() + "'" +
